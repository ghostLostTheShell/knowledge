...
public class SNMPV2demo {
    private Snmp snmp = null;
    private int version ;

    public SNMPV2demo(int version) {
        try {
    ...
    public void sendMessage(Boolean syn, final Boolean bro, PDU pdu, String addr)
        ...
        if (!syn) {
            ...
            System.out.println("数据类型："+ variable.getSyntax());
            /**
             * 输出结果：
    ...
    public static void main(String[] args) {
        ...
        SNMPV2demo manager = new SNMPV2demo(ver2c);
        // 构造报文
        PDU pdu = new PDU();
        //PDU pdu = new ScopedPDU();
        // 设置要获取的对象ID，这个OID代表远程计算机的名称
        OID oids = new OID(".1.3.6.1.2.1.2.2.1.4.5");
        PDU pdu1 = new PDU();
        OID oids1 = new OID(".1.3.6.1.2.1.1.5");
        ...
        try {
            ...
            //manager.sendMessage(false, true, pdu, "udp:192.168.2.45/161");//192.168.1.229 Linux服务器
