...
public class Snmpv3Demo2 {
    ...
    public static void main(String[] args) throws IOException {
            ...
            UsmUser user = new UsmUser(
                    ...
                    AuthMD5.ID, new OctetString("nmsAuthKey"), null, null);
        ...
        private static void snmpWalk(Snmp snmp, UserTarget target, OctetString contextEngineId) {
            ...
            List<TableEvent> table = utils.getTable(target, columnOids, new OID("3"), new OID("10"));
            for (TableEvent e : table) {
